...
const questionsFilePath = "./lib/questions.json";
//const
const render = require("./lib/htmlRenderer");
const chalk = require("chalk");
//display name, role, id, specific property
// syntax is saying run this block immediately, under async
...
(async() => {
    try {
        ...
        writeFileAsync(outputPath, employeeHtml);
        console.log("success!");
